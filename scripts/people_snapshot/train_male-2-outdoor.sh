...
# train a-pose
CUDA_VISIBLE_DEVICES=${1} python train.py --gpu-ids 0 --conf ./configs/people_snapshot/male-2-outdoor.conf --data ./people_snapshot_public_proprecess/male-2-outdoor/ --save-folder ${2} --project_name ${3} \

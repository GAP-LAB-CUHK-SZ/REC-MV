...
# train a-pose
CUDA_VISIBLE_DEVICES=${1} python train.py --gpu-ids 0 --conf ./configs/people_snapshot/male-9-plaza.conf --data ./people_snapshot_public_proprecess/male-9-plaza/ --save-folder ${2} --project_name ${3} \
